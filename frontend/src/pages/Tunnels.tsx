    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">{t.tunnels.loadingTunnels}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">{t.tunnels.title}</h1>
          <p className="text-muted-foreground">{t.tunnels.subtitle}</p>
        </div>
        ...
        {tunnels.map((tunnel) => {
          ...
          const getCoreBadge = () => {
            const coreColors: Record<string, { bg: string; text: string; border: string }> = {
              ...
              backhaul: { bg: 'bg-secondary/70', text: 'text-brand-accent', border: 'border-blue-300 dark:border-blue-700' },
            ...
            return coreColors[tunnel.core] || { bg: 'bg-secondary/60', text: 'text-gray-800 dark:text-gray-200', border: 'border-input' }
          }
          ...
          return (
            <div
              key={tunnel.id}
              className="glass-card p-5 transition-all hover:shadow-glow-brand"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1 min-w-0">
                  ...
                  <span
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap shrink-0 ${
                      tunnel.status === 'active'
                        ...
                        : 'bg-secondary/60 text-gray-800 dark:text-gray-200'
                    }`}
                  >
                    {tunnel.status}
                  </span>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <h3 className="text-base font-semibold text-foreground truncate">{tunnel.name}</h3>
                      <span
                      ...
                      {(() => {
                        ...
                        const getTransmissionBadge = () => {
                          const typeColors: Record<string, { bg: string; text: string; border: string }> = {
                            TCP: { bg: 'bg-success/15', text: 'text-success', border: 'border-green-300 dark:border-green-700' },
                            UDP: { bg: 'bg-warning/15', text: 'text-warning', border: 'border-yellow-300 dark:border-yellow-700' },
                          ...
                          return typeColors[transmissionType] || { bg: 'bg-secondary/60', text: 'text-gray-800 dark:text-gray-200', border: 'border-input' }
                        }
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm font-mono font-semibold text-foreground/90">{ports}</span>
                      </div>
                    </div>
                      ...
                      {(() => {
                        ...
                        return corePort ? (
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-foreground/90 font-mono">{corePort}</span>
                          </div>
                        ) : null
                      })()}
                      {iranNode && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-foreground/90">{iranNode.name || iranNode.id.substring(0, 8)}</span>
                        </div>
                      )}
                      {foreignServer && (
                        <div className="flex items-center gap-1.5">
                          <span className="font-medium">Server:</span>
                          <span className="text-foreground/90">{foreignServer.name || foreignServer.id.substring(0, 8)}</span>
                        </div>
                      )}
                    </div>
                ...
                <div className="flex gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="btn-icon hover:text-brand-accent"
                    title="Edit tunnel"
                  >
                    <Edit2 size={18} />
                  </button>
...
const EditTunnelModal = ({ tunnel, onClose, onSuccess }: EditTunnelModalProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    rathole_local_port: tunnel.spec?.local_port ? tunnel.spec.local_port.toString() : '',
  ...
  return (
    <div className="scrim flex items-center justify-center z-[100]">
      <div className="glass-panel rounded-lg p-6 w-full max-w-md">
        <h2 className="text-xl font-bold text-foreground mb-4">Edit Tunnel</h2>
            ...
            <>
              <div>
                ...
                <input
                  ...
                  max="65535"
                />
                <p className="field-hint">Rathole server port on panel (IP: {window.location.hostname})</p>
              </div>
              <div>
                <label className="field-label">
                  Local Port
          ...
          {tunnel.core === 'frp' && (
            <>
              ...
              <div>
                ...
                />
                <p className="field-hint">Authentication token (will be auto-generated if not provided)</p>
              </div>
            </>
          )}
...
const AddTunnelModal = ({ nodes, servers, onClose, onSuccess }: AddTunnelModalProps) => {
  ...
  return (
    <div className="scrim flex items-center justify-center z-[100] overflow-auto">
      <div className="glass-panel rounded-lg p-4 w-full max-w-xl my-4 max-h-[90vh] overflow-y-auto">
        <h2 className="text-xl font-bold text-foreground mb-4">{t.tunnels.createTunnel}</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="field-label">
              Name
          ...
          {formData.core !== 'gost' && (
            <>
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="v4_to_v6" className="text-sm font-medium text-foreground/90">
                  v4 to v6 tunnel
                </label>
              </div>
    ...
    <div className="space-y-4">
      ...
      <div className="pt-2">
        <button
          ...
          className="px-3 py-2 text-sm font-medium text-brand-accent hover:underline"
        >
          Advanced settings
        </button>
      </div>
...
function BackhaulAdvancedDrawer({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex">
      ...
      <div className="w-full max-w-xl h-full glass-panel-strong overflow-y-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-semibold text-foreground">Backhaul Advanced Settings</h3>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="field-label">Keepalive (s)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Heartbeat (s)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Channel Size</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Mux Concurrency</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Web UI Port</label>
                <input
                  type="number"
              ...
              <div className="col-span-2 flex items-center gap-3">
                <label className="text-sm font-medium text-foreground/90 flex-1">Enable Sniffer</label>
                <input
                  type="checkbox"
              ...
              <div className="col-span-2">
                <label className="field-label">Sniffer Log Path</label>
                <input
                  type="text"
              ...
              <div className="col-span-2">
                <label className="field-label">TLS Certificate Path</label>
                <input
                  type="text"
              ...
              <div className="col-span-2">
                <label className="field-label">TLS Key Path</label>
                <input
                  type="text"
              ...
              <div className="col-span-2 flex items-center gap-3">
                <label className="text-sm font-medium text-foreground/90 flex-1">Disable Optimizations</label>
                <input
                  type="checkbox"
              ...
              <div className="col-span-2 flex items-center gap-3">
                <label className="text-sm font-medium text-foreground/90 flex-1">Enable Proxy Protocol</label>
                <input
                  type="checkbox"
              ...
              <div className="col-span-2 flex items-center gap-3">
                <label className="text-sm font-medium text-foreground/90 flex-1">TCP Nodelay</label>
                <input
                  type="checkbox"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="field-label">Connection Pool</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Retry Interval (s)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="field-label">Dial Timeout (s)</label>
                <input
                  type="number"
              ...
              <div className="col-span-2">
                <label className="field-label">Edge IP (for WS/WSS)</label>
                <input
                  type="text"
              ...
              <div className="col-span-2 flex items-center gap-3">
                <label className="text-sm font-medium text-foreground/90 flex-1">Aggressive Pool</label>
                <input
                  type="checkbox"
