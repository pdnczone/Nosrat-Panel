    ...
    <div>
      ...
      {message && (
        <div className={`mb-4 p-4 rounded-lg ${
          message.type === 'success' 
            ? 'bg-green-100 dark:bg-green-900 text-success' 
      ...
      <div className="space-y-6">
        ...
        <div className="glass-panel rounded-xl p-6">
          <h2 className="text-lg font-semibold text-foreground mb-4">{t.settings.frpCommunication}</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <label htmlFor="frp-enabled" className="text-sm font-medium text-foreground/90">
        ...
        <div className="glass-panel rounded-xl p-6">
          <h2 className="text-lg font-semibold text-foreground mb-4">{t.settings.telegramBot}</h2>
          <p className="text-sm text-muted-foreground mb-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <label htmlFor="telegram-enabled" className="text-sm font-medium text-foreground/90">
            ...
            {settings.telegram.enabled && (
              <>
                ...
                <div className="border-t border-border/60 pt-4 mt-4">
                  <h3 className="text-md font-semibold text-foreground mb-3">{t.settings.automaticBackup}</h3>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <input
                      ...
                      className="rounded"
                    />
                    <label htmlFor="backup-enabled" className="text-sm font-medium text-foreground/90">
        ...
        <div className="glass-panel rounded-2xl p-6">
          <h2 className="text-xl font-semibold text-foreground mb-4">{t.settings.tunnelAutoReapply || 'Tunnel Auto Reapply'}</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${
                  settings.tunnel?.auto_reapply_enabled ? 'brand-gradient-bg' : 'bg-secondary'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
